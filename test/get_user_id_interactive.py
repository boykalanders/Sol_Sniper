#!/usr/bin/env python3
"""
Interactive script to get your Telegram user ID
Waits for messages in real-time
"""
...
def get_user_id_interactive(bot_token):
    """Get user ID from bot updates with interactive waiting"""
    url = f"https://api.telegram.org/bot{bot_token}/getUpdates"
    
    print("\n📱 Instructions:")
    print("   1. Open Telegram")
    print("   2. Search for your bot: @topsolsniper1_bot")
    print("   3. Send any message (like 'hello' or '/start')")
    print("   4. This script will detect your message automatically")
    print("\n⏳ Waiting for your message... (Press Ctrl+C to stop)")
...
if __name__ == "__main__":
    print("🤖 Telegram User ID Helper (Interactive)")
    print("=" * 40)
    ...
    if test_bot_token(bot_token):
        user_id = get_user_id_interactive(bot_token)
